...
use App\Application\Command\HomeWork\HomeWorkMarkCompleted;
use App\Infrastructure\MessageBus\CommandBus;
use App\UI\Controller\Saga\V1\HomeWork\Form\HomeWorkMarkCompletedForm;
...
#[Route(
    ...
    name: 'api_saga_v1_home_work_mark_completed',
    defaults: ['_format' => 'json', 'anonymous' => true],
    methods: [Request::METHOD_POST],
)]
#[BehatFeaturesPath(path: 'Api/Saga/V1/HomeWork/')]
final class HomeWorkMarkCompletedController extends AbstractController
{
    ...
    public function __invoke(
        CommandBus $queryBus,
        HomeWorkMarkCompletedForm $form
    ): void {
        $queryBus->dispatch(new HomeWorkMarkCompleted($form->id));
    }
}
