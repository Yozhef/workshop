...
#[Route(
    ...
    name: 'api_saga_v1_home_work_create',
...
{
    #[BehatFeature(status: Status::FAILURE, file: 'Homework.Create.feature', anchors: [
        'failBlankParams',
    ...
    public function __invoke(
        ...
        $queryBus->dispatch(new HomeWorkCreate($form->id, $form->title, new \DateTimeImmutable($form->dueDate), false));
    }
}
