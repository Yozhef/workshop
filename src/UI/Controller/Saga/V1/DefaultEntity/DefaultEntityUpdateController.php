...
use App\Application\Command\DefaultEntity\DefaultEntityUpdate;
use App\Infrastructure\MessageBus\CommandBus;
use App\UI\Controller\Saga\V1\DefaultEntity\Form\DefaultEntityUpdateForm;
...
#[Route(
    ...
    name: 'api_saga_v1_default_entity_update',
    defaults: ['_format' => 'json', 'anonymous' => true],
    methods: [Request::METHOD_PATCH],
)]
#[BehatFeaturesPath(path: 'Api/Saga/V1/DefaultEntity/')]
final class DefaultEntityUpdateController extends AbstractController
{
    ...
    #[OA\RequestBody(
        ...
        content: new OA\JsonContent(
            ref: new ApiDoc\Model(type: DefaultEntityUpdateForm::class),
        ),
    )]
    #[OA\Patch(responses: [
        new OA\Response(
    ...
    public function __invoke(
        CommandBus $queryBus,
        DefaultEntityUpdateForm $form,
    ): void {
        $queryBus->dispatch(new DefaultEntityUpdate($form->id, $form->name));
    }
}
